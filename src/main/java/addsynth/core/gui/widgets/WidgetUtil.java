...
// ========================================= BUTTON RENDER ===========================================
   ...
   * @param height
   */
  public static final void renderButton(GuiGraphics graphics, AbstractWidget widget, ResourceLocation texture, int texture_x, int texture_y, int width, int height){
    common_button_render_setup(texture); // widget.alpha is not visible
    graphics.blit(texture, widget.getX(), widget.getY(), texture_x, texture_y, width, height);
  }
   ...
   */
  public static final void renderButton(GuiGraphics graphics, AbstractWidget widget, ResourceLocation texture, int texture_x, int texture_y, int width, int height, int texture_width, int texture_height){
    common_button_render_setup(texture);
    graphics.blit(texture, widget.getX(), widget.getY(), width, height, texture_x, texture_y, texture_width, texture_height, 256, 256);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into top and bottom parts. */
  public static final void verticalSplitRender(GuiGraphics graphics, ResourceLocation texture, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_height){
    ...
    graphics.blit(texture, gui_x, gui_y,  width, half_height[0], texture_x, texture_y,  width, half_height[0], 256, 256);
    graphics.blit(texture, gui_x, gui_y2, width, half_height[1], texture_x, texture_y2, width, half_height[1], 256, 256);
  }

  /** Used to render a larger texture into a smaller space, by splitting the texture into left and right parts. */
  public static final void horizontalSplitRender(GuiGraphics graphics, ResourceLocation texture, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_width){
    ...
    graphics.blit(texture, gui_x,  gui_y, half_width[0], height, texture_x,  texture_y, half_width[0], height, 256, 256);
    graphics.blit(texture, gui_x2, gui_y, half_width[1], height, texture_x2, texture_y, half_width[1], height, 256, 256);
  }

  public static final void crossSplitRender(GuiGraphics graphics, ResourceLocation texture, int gui_x, int gui_y, int texture_x, int texture_y, int width, int height, int max_width, int max_height){
    ...
    final int texture_x2 = texture_x + max_width  - half_width[1];
    final int texture_y2 = texture_y + max_height - half_height[1];
    graphics.blit(texture, gui_x,  gui_y,  half_width[0], half_height[0], texture_x,  texture_y,  half_width[0], half_height[0], 256, 256);
    graphics.blit(texture, gui_x2, gui_y,  half_width[1], half_height[0], texture_x2, texture_y,  half_width[1], half_height[0], 256, 256);
    graphics.blit(texture, gui_x,  gui_y2, half_width[0], half_height[1], texture_x,  texture_y2, half_width[0], half_height[1], 256, 256);
    graphics.blit(texture, gui_x2, gui_y2, half_width[1], half_height[1], texture_x2, texture_y2, half_width[1], half_height[1], 256, 256);
  }
