...
public class ProgressBar {
  ...
  public void draw(GuiGraphics graphics, GuiContainerBase gui, Direction direction, float value, RoundMode round_mode){
    ...
    switch(direction){
    case LEFT_TO_RIGHT: graphics.blit(gui.GUI_TEXTURE, gui.getGuiLeft() + x, gui.getGuiTop() + y, texture_x, texture_y, progress, height); break;
    case RIGHT_TO_LEFT: graphics.blit(gui.GUI_TEXTURE, gui.getGuiLeft() + x + width - progress, gui.getGuiTop() + y, texture_x + width - progress, texture_y, progress, height); break;
    case TOP_TO_BOTTOM: graphics.blit(gui.GUI_TEXTURE, gui.getGuiLeft() + x, gui.getGuiTop() + y, texture_x, texture_y, width, progress); break;
    case BOTTOM_TO_TOP: graphics.blit(gui.GUI_TEXTURE, gui.getGuiLeft() + x, gui.getGuiTop() + y + height - progress, texture_x, texture_y + height - progress, width, progress); break;
    }
  }
