package addsynth.overpoweredtechnology.machines.identifier;
  ...
  public static final void enchant(final ItemStack stack){
    if(ItemUtil.itemStackExists(stack)){
      ...
      if(item instanceof ArmorItem){
        ...
        case HELMET:     enchant_helmet(stack); break;
        case CHESTPLATE: enchant_armor(stack); break;
        case LEGGINGS:   enchant_armor(stack); break;
        case BOOTS:      enchant_boots(stack); break;
        }
        return;
      }
