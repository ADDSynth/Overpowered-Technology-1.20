package addsynth.overpoweredtechnology.machines.fusion.chamber;
...
public final class TileFusionChamber extends TileStorageMachine implements MenuProvider {
  ...
  private static final SlotData[] slot_data = {new SlotData(OverpoweredItems.fusion_core, 1)};
  ...
  public final void explode(){
    ...
    level.explode(null, worldPosition.getX()+0.5, worldPosition.getY()+0.5, worldPosition.getZ()+0.5, FUSION_CHAMBER_EXPLOSION_SIZE, true, Level.ExplosionInteraction.BLOCK);
  }
