...
public final class WorkProgressBar extends ProgressBar {
  ...
  public final void draw(GuiGraphics graphics, GuiContainerBase gui, TileAbstractWorkMachine tile){
    work_time = tile.getWorkTimePercentage();
    super.draw(graphics, gui, Direction.LEFT_TO_RIGHT, work_time, RoundMode.Floor);
  }

  public final void draw(GuiGraphics graphics, GuiContainerBase gui, Direction direction, TileAbstractWorkMachine tile){
    work_time = tile.getWorkTimePercentage();
    super.draw(graphics, gui, direction, work_time, RoundMode.Floor);
  }
